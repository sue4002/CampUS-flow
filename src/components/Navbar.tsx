...
import { Bell, ChevronDown, LogOut, User, ShoppingCart } from "lucide-react";
            ...
            {!isLoggedIn ? (
              ...
              <>
                ...
                >
                  ...
                  {totalItems > 0 && (
                    <span className="absolute -top-0.5 -right-0.5 w-5 h-5 rounded-full bg-secondary text-primary-foreground text-xs font-bold flex items-center justify-center">
                      {totalItems}
                    </span>
                  )}
                </button>
